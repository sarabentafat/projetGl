...
function Offre() {
    return (
        <div className='p-4 mx-10  sm:mx-1  md:text-sm sm:text-xs'>
            ...
            <div className='flex '>
                <LeftSideBar/>
                <div className='md:flex  md:w-full  md:h-[630px] sm:h-[300px] '>
                    <div className=' md:p-2 md:w-[50%]'>
                        <div className='flex  hover:bg-[var(--primary-color)] cursor-pointer rounded-sm sm:ml-[55px] '>
                    ...
                    <div className=' md:h-full md:w-[50%] sm:pl-[60px] mt-2 '>
