        ...
        <div className="w-[90%]   ">
          <div className=" md:p-2 md:w-[90%] sm:w-[99%] sm:ml-1 p-2 rounded-lg ">
            <div className="flex hover:bg-[var(--primary-color)] cursor-pointer rounded-lg ">
              ...
              <div className="ml-2 mr-1 ">
                <h1> kamel a demandé une offre </h1>
                <p className="text-gray-500 text-thin">il y'a 12 heures</p>
              </div>
              <a
                className="md:ml-[50%] sm:mr-1"
          ...
          <div class="collapse" id="collapseExamplee">
            <div className="md:flex md:justify-around w-[80%]  ">
              <div className="bg-[var(--primary-color)]  p-3 rounded-lg sm:ml-10 md:mr-1 sm:w-full sm:mb-1 ">
                ...
                <div>
                  Categorie <span className="text-blue-500"> collège</span>
                </div>
                <div>
                  Tarif <span className="text-blue-500"> 500dz /mois</span>
                </div>
                <div>
                  Thème <span className="text-blue-500"> phisik</span>
                </div>
                <div>
                  Modalité <span className="text-blue-500"> en ligne</span>
                </div>
                <div>
                  Wilaya <span className="text-blue-500"> Alger</span>
                </div>
              </div>
              <div className="bg-[var(--primary-color)] p-3 rounded-lg sm:ml-10 md:mr-1 sm:w-full sm:mb-1  ">
                <div className="font-bold mb-3">
                ...
                <div>
                  Nom <span className="text-blue-500">obumansour</span>
                </div>
                <div>
                  Prénom <span className="text-blue-500">ouarda</span>
                </div>
                <div>
                  Téléphone <span className="text-blue-500">054442</span>
                </div>
                <div>
          ...
          <div className=" md:p-2 md:w-[90%] sm:w-[99%] sm:ml-1 p-2 rounded-lg ">
            <div className="flex hover:bg-[var(--primary-color)] cursor-pointer rounded-lg ">
              <img src={profilePic} alt="" className="w-8 h-8 mt-2 ml-1" />
              <div className="ml-2 mr-1 ">
                <h1>Anais a demandé une offre </h1>
                <p className="text-gray-500 text-thin">il y'a 12 heures</p>
              </div>
              <a
                className="md:ml-[50%] sm:mr-1"
          ...
          <div className=" md:p-2 md:w-[90%] sm:w-[99%] sm:ml-1 p-2 rounded-lg ">
            <div className="flex hover:bg-[var(--primary-color)] cursor-pointer rounded-lg ">
              <img src={profilePic} alt="" className="w-8 h-8 mt-2 ml-1" />
              <div className="ml-2 mr-1 ">
                <h1> Moncef a demandé une offre </h1>
                <p className="text-gray-500 text-thin">il y'a 12 heures</p>
              </div>
              <a
                className="md:ml-[50%] sm:mr-1"
