...
function AddAnnonce() {
    return (
        <div className='p-4 mx-10 sm:mx-1  md:text-sm sm:text-xs  sm:ml-2 '>
            ...
            <div className='flex'>
                <LeftSideBar />
                <div className='md:flex w-full sm:ml-14'>
                    <div className='bg-[var(--primary-color)]  border-2 border-gray-300 border-dashed  md:w-[50%] flex justify-center items-center sm:w-[65%]  '>
                        <div>
                            <img src={image} alt=" add image " className='p-3 ml-5 sm:w-[50%] ' />
                    ...
                    <div className=' md:w-[50%] p-5 shadow-sm sm:w-[320px] sm:ml-[-20px] md:ml-[5px] '>
                        <div className='font-bold mb-10 sm:mb-1 sm:w-[200px]  md:w-[300px]'>remplir les informations qui concerne le cours de soutien </div>
