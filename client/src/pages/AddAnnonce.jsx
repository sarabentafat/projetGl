...
function AddAnnonce() {
    return (
        <div  className='p-4 mx-10  '>
            ...
            <div className='bg-[var(--primary-color)]  border-2 border-gray-300 border-dashed  w-[50%] flex justify-center items-center'>
                <div>
                <img src={image} alt=" add image "  className='p-3 ml-5 '/>
            ...
            <div className=' w-[50%] p-5 shadow-sm'>
                <div className='font-bold mb-10'>remplir les informations qui concerne le cours de soutien </div>
                ...
                <div className='flex justify-center mt-10'>
                    <button className='bg-blue-500 text-white rounded-md w-[50%]'>partager l'annonce</button>
                </div>
