...
function Nav() {
  return (
    <div className='flex  justify-between mb-5 '>
      ...
      <div className=''>
        <input className=' border-gray-200 border-2 rounded-lg rounded-r-none p-1 lg:w-[400px] sm:w-[100px]' type="text" placeholder='Rechercher des annonces' />
        <button className=' bg-blue-500 text-white p-2 rounded-lg  ml-[-6px] sm:w-[5%px] '><AiOutlineSearch></AiOutlineSearch></button>
      </div>
